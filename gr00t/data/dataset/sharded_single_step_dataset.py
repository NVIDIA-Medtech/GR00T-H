...
# Constants for temporal percentile stats file handling
...
class ShardedSingleStepDataset(ShardedDataset):
    ...
    def get_percentile_statistics(self) -> dict | None:
        """
        Get percentile statistics for this dataset from its per-dataset file.
