    ...
    if (
        ...
        if hasattr(config.model, "shortest_image_edge") and hasattr(config.model, "crop_fraction"):
            assert (
                ...
                "Do not set shortest_image_edge and crop_fraction together with "
                "image_crop_size and image_target_size. If you are using a YAML config with "
                "only image_target_size/image_crop_size, set shortest_image_edge: null and "
                "crop_fraction: null explicitly."
            )
