...
├── README.md                        # This file
├── jhu_imerse_dvrk_config.py        # Modality configuration (registers with GR00T)
├── jhu_imerse_dvrk_mono_config.py   # Mono (endoscope-only) modality configuration
├── jhu_imerse_star_il_config.py     # IMERSE star_IL modality configuration
