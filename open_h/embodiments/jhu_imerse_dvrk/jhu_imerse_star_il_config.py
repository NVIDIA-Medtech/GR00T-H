"""IMERSE star_IL modality configuration for GR00T N1.7.
...
register_modality_config(imerse_star_il_config, embodiment_tag=EmbodimentTag.JHU_IMERSE_DVRK_STAR_IL)
