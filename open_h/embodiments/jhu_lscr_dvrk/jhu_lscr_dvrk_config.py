...
This module registers configurations for the LSCR schemas that are not already
covered by the standard dVRK embodiment:
...
register_modality_config(jhu_lscr_miracle_config, embodiment_tag=EmbodimentTag.JHU_LSCR_DVRK_MIRACLE)
