...
A healthcare robotics variant of [GR00T N1.6](https://github.com/NVIDIA/Isaac-GR00T), post-trained on the [Open-H dataset](open_h/README.md) for multi-embodiment surgical and healthcare robot autonomy across 16 robot platforms and 10+ institutions.
...
See [open_h/README.md](open_h/README.md) for multi-embodiment training and dataset preparation.
